    ...
    def mock_completion(self, user_prompt: str) -> str:
        if "章节正文" in user_prompt or "draft" in user_prompt.lower():
            paragraphs = [
                ...
                "“新来的，”那人笑着说，“你刚才钻的是考官的空子，不是我们的空子。废校宿舍按资格排位，你这个临时的，今晚睡哪？”",
                "这句话比嘲笑更狠。台下的新生立刻看向门后的石阶。石阶尽头挂着一排木牌，甲乙丙丁一路排到末等，每块木牌后面都对应着床位、饭额和夜巡豁免。没有床位的人，夜里只能留在操场。废校夜巡从不问原因。",
                "林砚掌心还在疼。他没有急着回答，而是看那人腰间的木牌。丙七。位置不高，但足够欺负一个临时新生。木牌边缘沾着一点新墨，和验词台红印下面的黑线一样，都是刚刚登记过的痕迹。",
                "他忽然明白，考官让他下台，不是放过他，而是把他丢进下一道更细的规矩里。这里每一步都有门槛，每个人都能借门槛收一次利息。",
                "“睡哪不急。”林砚抬起手，把灰白词条露出来，“先问清一件事。临时资格算不算资格？”",
                "丙七脸上的笑顿了一下。“算又怎样？”",
                "“算，就能参加排位。不能参加，你刚才那句‘按资格排位’就是错读校规。”林砚看向石阶旁的灰袍值守，“错读校规要扣谁的分？”",
                "灰袍值守原本像石头一样站着，听见这句，眼皮终于抬了抬。丙七的脸色变了。他想骂，却又不敢在值守面前把话说死。废校最要命的不是强者欺负弱者，而是弱者只要抓到字眼，也能让强者掉一层皮。",
                "林砚没有等他开口，直接往石阶走去。每走一步，掌心那枚词条就烫一下，像在数他还能透支多少力气。第一块木牌是甲一，后面空着；第二块是甲二，也空着。越往后，人越多，到了丙字牌前，几乎每个位置都有人盯着。",
